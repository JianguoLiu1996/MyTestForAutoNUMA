...
OUTPATH="/home/liujianguo/MyTestForAutoNUMA/memtier_benchmark_test/Redis_Experiment_I_OFF/"
CONFIG="memtier_benchmark_I_OFF"
...
function startRedisByNUMAInterleave(){
	...
	sudo numactl --interleave=all  sudo /etc/init.d/redis-server start
	...
	#wait
	echo "====success starting redis-server with interleave allocation===="
}
# 准备三个进程的数据
