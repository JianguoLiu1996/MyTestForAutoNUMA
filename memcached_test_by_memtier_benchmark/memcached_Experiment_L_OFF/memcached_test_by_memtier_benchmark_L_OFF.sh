...
OUTPATH="/home/liujianguo/MyTestForAutoNUMA/memcached_test_by_memtier_benchmark/memcached_Experiment_L_OFF/"
CONFIG="memcached_L_OFF"
...
#	sudo numactl --interleave=all memcached -d -p 11212 -m 10240
#	sudo numactl --interleave=all memcached -d -p 11213 -m 10240
