...
OUTPATH="/home/liujianguo/MyTestForAutoNUMA/memcached_test_by_memtier_benchmark/memcached_Experiment_I_OFF_3nd/"
CONFIG="memcached_I_OFF_3nd"
...
function startmemcached(){
	...
	wait
	echo "success to stop memcached server"
	sleep 3s
